    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{ url('/adminTableRecord') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                ...
                <form class="ms-md-auto pe-md-3 d-flex align-items-center" action="{{ route('admin.filter') }}" method="POST">
                    @csrf
                        ...
                        <div id="exportButtons" class="ms-md-auto pe-md-3 d-flex align-items-center">
                            <div>
                                <a class="btn btn-danger btn-sm mb-0 me-3"
                                    href="{{ route('admin.export', ['type' => 'pdf']) }}">Export as PDF</a>

                            </div>
                            <div>
                                <a class="btn btn-success btn-sm mb-0 me-3"
                                    href="{{ route('admin.export', ['type' => 'excel']) }}">Export as Excel</a>
