...
<body class="g-sidenav-show  bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{ url('/adminAccount') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="{{ url('/adminRecordTable') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <h6 class="font-weight-bolder mb-0">ACCOUNT PAGE</h6>
                </nav>
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        <li class="nav-item d-flex align-items-center">
                            <a class="btn btn-outline-primary btn-sm mb-0 me-3" href="#" data-toggle="modal"
                                data-target="#addBHWAccountModal"> <i class="fas fa-plus-circle"></i> BHW Account</a>
                        </li>
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody class="allData">
                                        @if ($bhwAccounts === null || $bhwAccounts->isEmpty())
                                            <tr>
                                                <td colspan="7"
                                                    class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                                    No records found.</td>
                                                ...
                                                @if ($bhwAccount->status === 'active')
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex px-2 py-1">
                                                                <div class="d-flex flex-column justify-content-center">
                                                                    <img src="{{ asset($bhwAccount->profile_picture) }}"
                                                                        width="50" height="50"
                                                        ...
                                                        <td class="align-middle text-center text-sm">
                                                            <h6 class="mb-0 text-sm">{{ $bhwAccount->middle_name }}
                                                            </h6>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td colspan="7"> <!-- Use colspan to span all columns -->
                                                            <div class="collapse"
                                                                id="collapseExample{{ $bhwAccount->id }}">
                                                                <div class="card card-body">
                                                                    <!-- Your collapsible content here -->
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <strong>Municipality:</strong>
                                                                            {{ $bhwAccount->municipality }}
                                                                        </div>
                                                                        <div class="col-md-6">
    ...
    <script>
        function deleteBHWAccount(id) {
            if (confirm('Are you sure you want to delete this BHW account?')) {
                $.ajax({
                    url: '/bhw-user/delete/' + id,
                    type: 'POST', // or 'DELETE' if your Laravel route is configured for DELETE method
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
                    success: function(response) {
                        // Handle success, such as removing the row from the table
                        $('#row_' + id).remove();
                        alert('BHW account deleted successfully');
                        // Redirect the user to the admin account page after successful deletion
    ...
    <script type="text/javascript">
        $('#search').keyup(function() {
            ...
            if (value) {
                ...
                // Assuming you want to send an AJAX request to the 'search' URL
                $.ajax({
                    type: 'GET',
                    url: '{{ url('searchBHW') }}', // Replace with your actual URL
                    data: {
                        'search': value
                    },
